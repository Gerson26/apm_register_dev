...
try {
    ...
    //Recipients
    $mail->setFrom('pruebass345@gmail.com', 'Name');
    $mail->addAddress($msg['email_send'], $msg['name']);     //Add a recipient
    //$mail->addAddress("{$msg['email_send']}", "{$msg['name']}");
...
<body leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
    ...
    <div class="container">
    <img src="https://dualdisorderswaddmexico2022.com/img/apm_email.jpeg" alt="">
